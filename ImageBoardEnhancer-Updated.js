...
(async () => {
    ...
    function hideSettings() {
      ...
      $("#hideIconSensitiveCheckbox").prop('checked', hiddenIcons.includes("sensitive"));
    ...
    function saveSettings() {
      ...
      if ($('#hideIconSensitiveCheckbox').is(':checked')) newHiddenIcons.push('sensitive');
          ...
          <div id="ibenhancerSettings">
            <div id="ibenhancerSettings-options">
              ...
              <span id="iconCheckboxes">
                ...
                <label><input id="hideIconSensitiveCheckbox" type="checkbox" ` + (hiddenIcons.includes("sensitive") ? `checked` : ``) + `>Rating: Sensitive</label>
                ...
                <label><input id="hideIconUncensoredCheckbox" type="checkbox" ` + (hiddenIcons.includes("uncensored") ? `checked` : ``) + `>uncensored</label>
              </span>
              <br>
    ...
    function addEnhancedThumbnails() {
            ...
            <span>
              <div id="thumbPlusPreview" class="">
                ...
                <div id="thumbPlusIcons" style="position: relative;">
                  ...
                  <span id="thumbPlusPreviewSensitive" class="thumbPlusPreviewIcon ` + (hiddenIcons.includes("sensitive") ? `` : `show`) + `" tooltip="Rating: Sensitive">` + icons['sensitive'] + `</span>
      ...
      function closeThumb() {
        if ((!debugMode || (!keepThumbOpen && debugMode)) && !thumbDetailsOpen) {
          ...
          $('#thumbPlusPreview').removeClass('show gif video sound flash straight gay lesbian trans threed trap loli shota gore pregnant bestiality feet bondage poop piss group incest bukkake tentacles rape public furry fat hypnosis ntr femdom sensitive questionable explicit uncensored');
        }
      }
      ...
      function thumbnailMouseOver(thumb) {
        ...
        if (tags.includes("rating:sensitive")) $('#thumbPlusPreview').addClass('sensitive');
        else if (tags.includes("sensitive")) $('#thumbPlusPreview').addClass('sensitive');
        else if (tags.includes("rating:s")) $('#thumbPlusPreview').addClass('sensitive');
        ...
        else if (tags.includes("decensored")) $('#thumbPlusPreview').addClass('sensitive');
